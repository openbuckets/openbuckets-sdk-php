...
/**
 * FileSearchResults Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class FileSearchResults implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'FileSearchResults';
    ...
    protected static $openAPITypes = [
        'total' => 'int',
        'results' => '\OpenAPI\Client\Model\File[]'
    ];
    ...
    */
     ...
     * Sets total
     *
     * @param int|null $total Total number of matching files
     *
     * @return self
     */
     ...
     * Sets results
     *
     * @param \OpenAPI\Client\Model\File[]|null $results results
     *
     * @return self
     */
